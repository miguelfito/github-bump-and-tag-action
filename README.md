...
- **commit_sha** _(optional)_ - Which commit SHA want to tag (default: `GITHUB_SHA`).
...
[mathieudutour/github-tag-action](https://github.com/mathieudutour/github-tag-action) - a similar action tagging over `$GITHUB_SHA` commit.
