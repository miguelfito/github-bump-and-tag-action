...
function createTag(newTag, createAnnotatedTag, commitSha) {
    return __awaiter(this, void 0, void 0, function* () {
        let annotatedTag = undefined;
        if (createAnnotatedTag) {
            core.debug(`Creating annotated tag.`);
            annotatedTag = yield octokit.git.createTag(Object.assign(Object.assign({}, github_1.context.repo), { tag: newTag, message: newTag, object: commitSha, type: "commit" }));
        }
        core.debug(`Pushing new tag to the repo.`);
        yield octokit.git.createRef(Object.assign(Object.assign({}, github_1.context.repo), { ref: `refs/tags/${newTag}`, sha: annotatedTag ? annotatedTag.data.sha : commitSha }));
    });
}
